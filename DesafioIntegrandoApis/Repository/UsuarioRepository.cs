    ...
    public class UsuarioRepository
    {
        ...
        public List<Usuario> TraerUsuarioPorNombre(string Nombre)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = db.Connection.CreateCommand();
                    cmd.CommandText = "SELECT Id,Nombre,Apellido,NombreUsuario,Contraseña,Mail FROM Usuario WHERE Nombre=@NomUsu";
        ...
        public Usuario LoginUsuario(string NombreUsuario, string Pass)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = db.Connection.CreateCommand();
                    cmd.CommandText = "SELECT Id,Nombre,Apellido,NombreUsuario,Contraseña,Mail FROM Usuario WHERE NombreUsuario=@NomUsu AND Contraseña=@passUsu";
